...
# Define named vector of colors for each Genus
...
ui <- fluidPage(
  ...
  fluidRow(
    # VIS1 and MAP
    column(4,
           h4("Count of Frog Genera with their preferred terrain")),
    column(8,
           h4("Observation Locations Map and the number")),
    ...
    # DES2
    column(12,
           h4("Frog Frequency and Location of Frogs")),
    column(12,
    ...
    # DES3 and VIS2
    column(6,
           h4("Observation times of Top 4 Frog Genera")),
    column(6,
